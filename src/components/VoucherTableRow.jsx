    ...
    <tr className="group odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
      ...
      <td>
        <button
          ...
          className="record-del  pointer-events-none group-hover:pointer-events-auto duration-200 opacity-0 group-hover:opacity-100 left-full top-3 translate-x-2 active:scale-75 bg-blue-100 p-2 rounded-lg"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
