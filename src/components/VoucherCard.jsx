      ...
      <div id="printArea" className="w-[14.8cm]   bg-white ">
        ...
        <table className="w-full mb-8">
          <thead>
            <tr className="border-b-2 border-gray-300">
              ...
              <th className="text-left py-2 text-sm">Qty</th>
              <th className="text-left py-2 text-sm">Price</th>
        ...
        <div className=" text-xs mb-8">
          <div className="mb-4">
            ...
            <p>Kpay,Wave: 0987654321</p>
            <p>KBZ Bank : 0987654322355644</p>
            <p>AYA Bank : 0987654322355644</p>
          </div>
        ...
        <div className="border-t-2 border-gray-300 pt-4">
          <p className="mt-4 text-center">Thanks to You</p>
        </div>
      </div>
